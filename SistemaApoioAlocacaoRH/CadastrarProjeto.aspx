<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="true" CodeBehind="CadastrarProjeto.aspx.cs" 
    Inherits="SistemaApoioAlocacaoRH.CadastrarProjeto" Culture="pt-BR" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <asp:Label ID="lblTitle" runat="server" Text="Cadastrar Projeto" />
                        <small>
                            <asp:Label ID="lblSubTitle" runat="server" Text="Cadastrar um novo projeto no sistema " />
                        </small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rqvNomeProjeto" runat="server" ControlToValidate="txtNomeProjeto" ErrorMessage="Nome do projeto não pode ser vazio!" Display="None" />
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rqvDataInicio" runat="server" ControlToValidate="txtDataInicio" ErrorMessage="Data de Início não pode ser vazia!" Display="None" />
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rqvDataTermino" runat="server" ControlToValidate="txtDataTermino" ErrorMessage="Data de Término não pode ser vazia!" Display="None" /> 
                        <asp:CompareValidator ID="cvDataTermino" runat="server" ControlToCompare="txtDataInicio" CultureInvariantValues="true" Display="None" EnableClientScript="true"
                            ControlToValidate="txtDataTermino" ErrorMessage="A data de inicio não pode ser maior que a data de término!" Type="Date" Operator="GreaterThanEqual" />                                                    
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rqvStatusProjeto" runat="server" ControlToValidate="ddlStatusProjeto" ErrorMessage="Status do Projeto não pode ser vazio!" Display="None" />
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rqvPrioridadeProjeto" runat="server" ControlToValidate="ddlPrioridadeProjeto" ErrorMessage="Prioridade do Projeto não pode ser vazio!" Display="None" />
                    </div>
                </div>               
            </div>
            <hr />
