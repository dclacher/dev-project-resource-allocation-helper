<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="true" CodeBehind="AtualizarCompetencias.aspx.cs" Inherits="SistemaApoioAlocacaoRH.AtualizarCompetencias" Culture="pt-BR" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <asp:Label ID="lblTitle" runat="server" Text="Atualizar Competências" />
                        <small>
                            <asp:Label ID="lblSubTitle" runat="server" Text="Atualizar conhecimentos, habilidades ou atitudes de um funcionário" />
                        </small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            ...
                            <asp:Label ID="lblPageName" runat="server" Text="Atualizar Competências" />
                        </li>
                    </ol>
                </div>
            </div>
